...
```{r echo=TRUE}
#import data
sample_df <- read.table("112434586048_T2T.methyl.filtered.bed", quote="\"", comment.char="")
hap1 <- read.table("112434586048_T2T_1.methyl.filtered.bed", quote="\"", comment.char="")
hap2 <- read.table("112434586048_T2T_2.methyl.filtered.bed", quote="\"", comment.char="")
...
```{r include=FALSE}
#import ctrls
ctrls= read_excel("ctrls_hg38.xlsx",1)
ctrls<- ctrls [, c(2:4)]
